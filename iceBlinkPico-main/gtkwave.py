...
if __name__ == "__main__":
    ...
    sv_name = input("SV File (top.sv): ") or "caches/direct_mapped_cache.sv"
    testbench_name = input("Testbench File (testbench.sv): ") or "testbenches/direct_mapped_cache_tb.sv"
